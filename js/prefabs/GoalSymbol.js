 ...
 * @constructor
 */
SuperILtan.GoalSymbol = function(gameState, x, y, tiledMapObject) {
	'use strict';
 ...
 * @override
 */
SuperILtan.GoalSymbol.prototype.update = function() {
	'use strict';
 ...
 * @private
 */
SuperILtan.GoalSymbol.prototype.onCollectCallback_ = function(coin, player) {
	'use strict';
	coin.kill();
	// addScore
}
